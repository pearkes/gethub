...
func TestStepCheckConfiguration_No_Config(t *testing.T) {
...
func TestStepCheckConfiguration_Corrupt_Config(t *testing.T) {
	env = make(map[string]interface{})
...
func TestStepCheckConfiguration_Good_Config(t *testing.T) {
	env = make(map[string]interface{})
